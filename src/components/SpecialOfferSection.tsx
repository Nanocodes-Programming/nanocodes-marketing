        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 border-2 border-white shadow-2xl">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-10">
              {[
                { icon: "🎨", title: "FREE UI/UX Design Consultation", value: "🇿🇦 Worth R2,500 | 🇳🇬 Worth ₦150,000" },
                { icon: "🌐", title: "FREE 1-year domain + SSL certificate", value: "🇿🇦 Worth R750 | 🇳🇬 Worth ₦45,000" },
                { icon: "📊", title: "FREE Project management tools", value: "🇿🇦 Worth R1,400/year | 🇳🇬 Worth ₦80,000/year" },
                { icon: "🔍", title: "FREE SEO audit & optimization", value: "🇿🇦 Worth R2,000 | 🇳🇬 Worth ₦120,000" },
                { icon: "💰", title: "15% Discount on total project cost", value: "Applies to any project size" },
                { icon: "🛡️", title: "Extended Support: 6 months", value: "Instead of 3 months FREE" },
              ].map((bonus, index) => (
                <div
                  key={index}
